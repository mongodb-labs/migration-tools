...
func (b *Builder) Build() Config {
	...
	// Normalize namespace: strip trailing slashes so a caller who passes
	// "myproject/go-cache/" doesn't produce a double-slash in the S3 path.
	b.config.Namespace = strings.TrimRight(b.config.Namespace, "/")
...
func (c *Config) ComputeKeyCommands() shrub.CommandSequence {
...
func (c *Config) RestoreCommands() shrub.CommandSequence {
...
// and upload it to S3.
func (c *Config) SaveCommands() shrub.CommandSequence {
	createArgs := []string{
